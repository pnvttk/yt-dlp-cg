                ...
                <div className="grid grid-cols-2 gap-4">
                     <label className="flex items-center gap-2 cursor-pointer bg-surface p-2 rounded hover:bg-surface/80">
                         <input 
                             ...
                             onChange={(e) => {
                                 e.stopPropagation();
                                 updateFeature?.("postProcess", { embedThumbnail: e.target.checked });
                             }}
                      ...
                      <label className="flex items-center gap-2 cursor-pointer bg-surface p-2 rounded hover:bg-surface/80">
                         <input 
                             ...
                             onChange={(e) => {
                                 e.stopPropagation();
                                 updateFeature?.("postProcess", { embedMetadata: e.target.checked });
                             }}
                             className="accent-orange-500 w-4 h-4"
                         />
                      ...
                      <div className="flex flex-col gap-2">
                           <label className="flex items-center gap-2 cursor-pointer bg-surface p-2 rounded hover:bg-surface/80">
                             <input 
                               ...
                               onChange={(e) => {
                                   e.stopPropagation();
                                   updateFeature?.("postProcess", { embedSubs: e.target.checked });
                               }}
                               className="accent-orange-500 w-4 h-4"
                             />
